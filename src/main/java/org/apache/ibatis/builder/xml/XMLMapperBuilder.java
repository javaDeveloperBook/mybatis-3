...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  private XMLMapperBuilder(XPathParser parser, Configuration configuration, String resource, Map<String, XNode> sqlFragments) {
    ...
    super(configuration);
    /**
     * 创建 MapperBuilderAssistant 助手对象
     * MapperBuilderAssistant 是 XMLMapperBuilder 和 MapperAnnotationBuilder 的小助手
  ...
  private void configurationElement(XNode context) {
    try {
      ...
      // 判断 namespace 为 null 或 "" 抛出 BuilderException 异常
      if (namespace == null || namespace.equals("")) {
        throw new BuilderException("Mapper's namespace cannot be empty");
      }
      // 向 builderAssistant 助手对象设置 namespace 属性
  ...
  private void cacheRefElement(XNode context) {
    if (context != null) {
      ...
      try {
        ...
        // 若解析失败，添加到 configuration 的 incompleteCacheRefs 中
  ...
  private boolean databaseIdMatchesCurrent(String id, String databaseId, String requiredDatabaseId) {
    if (requiredDatabaseId != null) {
      ...
      // 如果未设置 requiredDatabaseId ，但是设置 databaseId 存在，说明还是不匹配，则返回 false
      if (databaseId != null) {
        return false;
      }
      // skip this fragment if there is a previous one with a not null databaseId
      // 如果前一个片段具有非 null databaseId，则跳过此片段
    ...
    if (namespace != null) {
      ...
      if (boundType != null) {
        ...
        if (!configuration.hasMapper(boundType)) {
          ...
          // Spring 可能不知道真正的资源名称所以我们设置一个标志来防止从mapper接口
          // 再次加载这个资源看看MapperAnnotationBuilder＃loadXmlResource
          // 标记 namespace 已经添加，避免 MapperAnnotationBuilder#loadXmlResource(...) 重复加载
          configuration.addLoadedResource("namespace:" + namespace);
          // 添加到 configuration 的 MapperRegistry 中,
